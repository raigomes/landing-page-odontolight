    ...
    <header className="w-full bg-white sticky top-0 z-40">
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-0 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <Link
            href="#booking"
            className="inline-flex items-center justify-center px-[18px] py-2 bg-brand-blue hover:bg-blue-500 text-white text-sm font-semibold rounded-[6px] transition-colors"
          >
            Agende
          </Link>
        </nav>
      ...
      >
        <nav className="flex flex-col gap-1 px-4 pb-4">
          ...
          <Link
            href="#booking"
            onClick={close}
            className="mt-2 text-center px-[18px] py-2.5 bg-brand-blue hover:bg-blue-500 text-white text-sm font-semibold rounded-[6px] transition-colors"
          >
            Agende
          </Link>
        </nav>
