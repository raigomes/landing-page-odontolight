...
1. Auditar se todas as tags estruturais são semânticas (bloquear divs genéricas onde cabem `<section>` ou `<nav>`).
...
5. Garantir a semelhança visual entre o site e o layout.pen (fontes, imagens, espaçamento, textos, CTA etc.). Caso não esteja, retornar os ajustes para o modo desenvolvedor.
